        ...
        window.methodDraw = function ($) {
            ...
            Editor.uiStrings = {
                common: {
                    "ok": "OK",
                    "cancel": "Abbrechen",
                    "key_up": "Pfeil nach oben",
                    "key_down": "Pfeil nach unten",
                ...
                notification: {
                    ...
                    "QwantToClear": "<strong>Möchten Sie das Kantteil löschen?</strong>\nDieser Schritt kann nicht rückgängig gemacht werden",
                    "QwantToOpen": "<strong>Möchten Sie die Datei öffnen?</strong>\nDas aktuelle Kanttteil wird dabei gelöscht",
            ...
            var uiStrings = Editor.uiStrings,
                curPrefs = {},
                customHandlers = {};
            ...
            Editor.init = function () {
                ...
                if (!isMac) {
                    $('.shortcut').each(function () {
                        var text = $(this).text();
                        $(this).text(text.split("⌘").join("Strg+"));
                    });
                }
        ...
        #g_panel > *, #tool_font_size > *, .tools_flyout';
          ...
          <defs><linearGradient id="gradbox_"/></defs></svg>', 'text/xml');
                    ...
                    var docElem = svgdocbox.documentElement,
                        con = $(container) && $(container)[0] ? $(container)[0] : $('<div></div>')[0];


                    docElem = con.appendChild(document.importNode(docElem, true));
          ...
          // Standard shortcuts
                ...
                Editor.ready(function () {
                    ...
                    tool.click(
                        function (event) {
                            if (toolButtonClick('#' + $(this).attr('id'))) {
                                svgCanvas.setMode('path');
                            }
